...
function ActualizarCantidad() {
    ...
    let CantidadNueva = document.getElementById("Mod_Cantidad").value;
   
    console.log(typeof(CantidadNueva),typeof(CantidadActual))
    if ( parseInt(CantidadNueva) < parseInt(CantidadActual)) {
        alert("El cantidad debe ser mayor a la actual..");
    } else {

        var ObjetoTabla = {
            Clave: document.getElementById("Mod_Clave").value,
            Producto: document.getElementById("Mod_Producto").value,
            Planta: document.getElementById("Mod_Almacen").value,
